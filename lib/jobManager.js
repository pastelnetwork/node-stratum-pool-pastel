...
var JobManager = module.exports = function JobManager(options) {
    ...
    this.processShare = async function (jobId, previousDifficulty, difficulty, extraNonce1, extraNonce2, nTime, nonce, ipAddress, port, workerName, workerPassword, soln) {
        ...
        const [pslAddress, remoteAPIValidatorIp] = workerName.split('|'); // workerName is in the format: <pslAddress>|<remoteIp>
        ...
        const authToken = workerPassword; // We are reusing the workerPassword field for the authToken
        ...
        console.log('processShare ck1: ', jobId, previousDifficulty, difficulty, extraNonce1, extraNonce2, nTime, nonce, ipAddress, port, pslAddress, soln)
        ...
        let previousBlockMerkleRoot = await blockTemplate.getPreviousBlockMerkleRoot();
        ...
        */
        ...
        blockTemplate.validateShareAsync(shareId, _this);  // Pass the context (_this) if necessary
