...
var JobManager = (module.exports = function JobManager(options) {
  ...
  this.processShare = async function (
    ...
    // Serialize the header data without nonce and solution
    const equihashInputBuffer = job.serializeEquihashInput(nTime, refreshedWorkerData);
    // Serialize full header
    const headerBuffer = job.serializeBlockHeader(equihashInputBuffer, nonce, soln);
    ...
    console.log(`headerBigNum as string: ${headerBigNum.toString(16).padStart(64, '0')}`);
    console.log(`  job.target as string: ${job.target.toString(16).padStart(64, '0')}`);
