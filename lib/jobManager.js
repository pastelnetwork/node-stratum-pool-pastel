...
var JobManager = (module.exports = function JobManager(options) {
  ...
  this.processShare = async function (
    ...
    // TODO: Revisit the -30 once everything is working. This is a temporary fix to account for the time difference between the miner and the pool
    ...
    const equihashInput = await job.serializeEquihashInput(headerDataParts, nonce);
