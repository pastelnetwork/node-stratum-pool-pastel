...
var JobManager = (module.exports = function JobManager(options) {
  ...
  this.processShare = async function (
    ...
    const headerBuffer = await job.serializeHeader(nTime, nonce, refreshedWorkerData); // Now 144 bytes (doesn't contain soln) (JE: actually more than that because of the additional header fields)
