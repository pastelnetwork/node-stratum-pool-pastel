...
this.serializeHeader = async function(nTime, nonce, workerData) {
    ...
    if (this.rpcData.version >= 5) {
        // PastelID
        const pastelid_value_in_hex = this.stringToHex(workerData.currently_selected_supernode_pastelid_pubkey);
        ...
        // Signature
        const signature_value_in_hex = this.stringToHex(workerData.currently_selected_supernode_signature);
