...
async function validateShareAsync(shareId, context) {
    ...
    try {
        // Ensure global_worker_dict is kept up to date with worker updates
        let canAcceptShares = global_worker_dict[pslAddressOfWorker]?.can_accept_mining_workers_shares_currently ?? false;
