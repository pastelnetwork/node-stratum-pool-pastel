...
async function startMonitoring() {
    ...
    try {
        // Now you can use blockchainOps to access its methods
        const heightAndHash = await blockchainOps.getCurrentPastelBlockHeightAndHash();
        console.log(heightAndHash);
        // Proceed with other operations...
    } catch (error) {
        console.error("Failed to start monitoring or execute blockchain operation:", error);
    }
}
