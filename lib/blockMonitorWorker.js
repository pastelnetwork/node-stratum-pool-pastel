...
const { PastelBlockchainOperations } = require('pastel_nodejs_client');
...
// Example of sending a message to the main thread, e.g., upon successful update or error
parentPort.postMessage({ type: 'update', data: { workerId: 'someId', status: 'updated' } });